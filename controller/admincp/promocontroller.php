...
class PromoController extends AppController{
	...
	private function dataValidate(){
		...
		if($mysidia->input->post("fromdate") && $mysidia->input->post("todate") && (strtotime($mysidia->input->post("fromdate")) > strtotime($mysidia->input->post("todate")))) throw new InvalidActionException("date");
