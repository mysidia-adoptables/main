...
class RegisterView extends View{
	...
	public function index(){
        ...
        $requiredField->add(new Comment("Your username may be up to 20 characters long with letters, numbers and spaces only, and it must start with a letter."));
        ...
        $additionalField->add(new Comment("(YYYY-mm-dd)"));	
        $additionalField->add(new TextField("birthday"));
		$additionalField->add(new Comment("Avatar: ", FALSE, "b"));
        $additionalField->add(new Comment("Enter the url of your avatar beginning with http:// or https://"));	
