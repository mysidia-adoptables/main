...
final class MysFloat extends Number
{
    ...
    {
        if ($this->intValue() < Byte::MinValue || $this->intValue() > Byte::MaxValue) {
    ...
    {
        if ($this->intValue() < Short::MinValue || $this->intValue() > Short::MaxValue) {
    ...
    {
        if ($this->intValue() < Integer::MinValue || $this->intValue() > Integer::MaxValue) {
    ...
    {
        if ($this->intValue() < Long::MinValue || $this->intValue() > Long::MaxValue) {
