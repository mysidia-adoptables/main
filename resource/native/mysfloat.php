...
final class MysFloat extends Number{
    ...
    public function toByte(){
	    if($this->intValue($this->value) < Byte::MinValue || $this->intValue($this->value) > Byte::MaxValue){
	...
	public function toShort(){
	    if($this->intValue($this->value) < Short::MinValue || $this->intValue($this->value) > Short::MaxValue){
	...
	public function toInteger(){
	    if($this->intValue($this->value) < Integer::MinValue || $this->intValue($this->value) > Integer::MaxValue){
	...
	public function toLong(){
	    if($this->intValue($this->value) < Long::MinValue || $this->intValue($this->value) > Long::MaxValue){
