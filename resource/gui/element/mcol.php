...
/**
 * The MCol Class, extends from abstract GUI Element class.
...
class MCol extends Element
{
    ...
    /**
     * The count property, specifies the number of columns available.
     * @access protected
     * @var Int
     */
    protected $count;
    ...
    /**
     * Magic method __toString for MCol class, it reveals that the object is a MCol.
     * @access public
     * @return String
     */
    public function __toString(): string
    {
        return "This is an instance of Mysidia MCol class.";
    }
}
