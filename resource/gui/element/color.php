...
use Resource\GUI\Helper\ColorHelper;
...
class Color extends Element{
    ...
    */
	...
	/**
	 * The code property, specifies the hex color code.
	 * @access protected
	 * @var String
    */
	protected $code;
    ...
    */
	 ...
	 * @var String
    */
	protected $names = ["aliceblue", "black", "blue", "brown", "coral", "cyan", "fuchsia", "gold", 
    ...
    */
	...
	public function setCode($code = ""){
	    if(strpos(code, "#") === FALSE) throw new GUIException("Color code must start with the symbol #");
		$this->code = $code;
	}
    ...
    public function __toString(){
	    return "This is an instance of Mysidia Color class.";
	}    
} 