...
/**
 * The Background Class, extends from abstract GUI Element class.
...
class Background extends Element{
    ...
    /**
	 * The attachment property, specifies the background attachment property(scrolled or fixed).
	 * @access protected
	 * @var String
    */
    ...
    */
	...
	public function setAttachment($attachment){
	    $attachments = ["scroll", "fixed", "inherit"];
	...
	public function setPosition($position){
	    $positions = ["bottom", "left", "right", "top", "center"];
	...
	public function setClip($clip){
	    $clips = ["border-box", "padding-box", "content-box"];
	...
	public function setOrigin($origin){
	    $origins = ["border-box", "padding-box", "content-box"];
