...
class ListRenderer extends Renderer{
	...
	public function __construct(Container $component){
		...
		if($component instanceof Container\LinksList) $this->tag = $component->getType();
		elseif($component instanceof Container\FieldSet) $this->tag = "fieldset"; 
        elseif($component instanceof Container\DataList) $this->tag = "datalist";
        elseif($component instanceof Container\DropdownList) $this->tag = "select";		
        else $this->tag = "";	
	}
