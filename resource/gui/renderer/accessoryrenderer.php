...
use Resource\GUI\Component\Media;
use Resource\GUI\Renderer;

/**
 * The AccessoryRenderer Class, extends from abstract GUI Renderer class.
 * It is responsible for rendering accessory type GUI Components.
 * @category Resource
 * @package GUI
 * @subpackage Renderer
...
class AccessoryRenderer extends Renderer{
	...
	public function __construct(Accessory $accessory){
		...
		else $this->tag = str_replace("resource\\gui\\component\\", "", strtolower($accessory->getClassName()));
    }
