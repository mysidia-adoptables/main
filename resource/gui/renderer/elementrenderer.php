...
class ElementRenderer extends Renderer{
	...
	public function renderWidth(){
	    if($this->component->getWidth()){
            if($this->component instanceof Element\Dimension) $this->setRender(" width:{$this->component->getWidth()};");
	...
	public function renderImage(){
        ...
        if($image instanceof Image){
		    if($this->component instanceof Element\Background) $this->setRender(" background-image:");
