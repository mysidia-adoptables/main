...
/**
 * The ElementRenderer Class, extends from abstract GUI Renderer class.
...
{
    /**
     * Constructor of ElementRenderer Class, assigns the text reference and determines its tag.
    ...
    public function __construct(Element $element)
    {
        ...
        if ($element instanceof Element\Font) {
            $this->tag = "span";
        } elseif ($element instanceof Element\Color) {
            $this->tag = null;
        } else {
            $this->tag = strtolower($element::class);
        }
    }
    ...
    {
        if ($this->component->getWidth()) {
            if ($this->component instanceof Element\Dimension) {
    ...
    public function renderImage()
    {
        ...
        if ($image instanceof Image) {
            if ($this->component instanceof Element\Background) {
                $this->setRender(" background-image:");
            } elseif ($this->component instanceof Element\Borders) {
