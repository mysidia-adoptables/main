...
abstract class SubMap extends Map implements NavigableMappable{
    ...
    */		
     ...
     * @param int  $fromStart
	 * @param Objective  $low
     * @param Boolean  $lowInclusive
     * @param int  $toEnd
     * @param Objective  $high
     * @param Boolean  $highInclusive
     * @access public
     * @return void
     */	
	public function __construct(TreeMap $map, $fromStart, Objective $low = NULL, $lowInclusive = FALSE, $toEnd = NULL, Objective $high = NULL, $highInclusive = FALSE){
