...
class Path extends Core implements Initializable
{
    ...
    public function __construct()
    {
        ...
        $this->absolute = $this->protocol . "://".DOMAIN.SCRIPTPATH."/";
        $this->root = getenv('DOCUMENT_ROOT').SCRIPTPATH."/";
        $this->tempRoot = SCRIPTPATH."/";
        $this->path = new ArrayObject(["{$this->root}classes/core", "{$this->root}classes/exception", "{$this->root}classes/user", "{$this->root}classes/message", "{$this->root}classes/item", "{$this->root}classes/shop"]);
