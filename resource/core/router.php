...
final class Router extends Core
{
    ...
    {
        if (str_contains($url, "admincp")) {
            $this->frontController = "AdminCP";
        } elseif (str_contains($url, "install")) {
    ...
    {
        $this->appController = $controller ?: "index";
    }
    ...
    {
        if ($action && str_contains($action, "page-")) {
            $this->action = "index";
            $this->setPage($action);
        } else {
    ...
    private function setParams($params)
    {
        ...
        foreach ($parameters as $parameter) {
            ...
            if (!empty($param) && str_contains((string) $param, "page-")) {
                $this->setPage($param);
            } else {
    ...
    {
        return (str_contains((string) end($query), "page-"));
    }
