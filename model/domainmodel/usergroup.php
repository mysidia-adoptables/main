...
class Usergroup extends Model
{
    ...
    public function __construct($group, $dto = null)
    {
        ...
        if (empty($group)) {
            $group = "visitors";
        } elseif ($group instanceof MysString) {
    ...
    public function getPermission($perms)
    {
        if (isset($this->$perms)) {
            ...
            throw new InvalidIDException('The permission name does not exist, something must be very very wrong');
        }
    }
