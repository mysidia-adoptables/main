...
class ItemFunction extends Model
{
    ...
    protected function applyBreed2(OwnedItem $item, OwnedAdoptable $adopt): never
    {
    ...
    protected function applyAlt2(OwnedItem $item, OwnedAdoptable $adopt)
    {
    ...
    protected function applyName1(OwnedItem $item, OwnedAdoptable $adopt): never
    {
        throw new ItemException("Currently adoptables can change name freely, there is no need to use an item");
    }

    protected function applyName2(OwnedItem $item, Member $user): never
    {
    ...
    protected function applyRecipe(OwnedItem $item, OwnedAdoptable $adopt): never
    {
