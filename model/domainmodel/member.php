...
class Member extends User
{
    ...
    public function isRootAdmin()
    {
        ...
        if ($this->usergroup == 2 || $this->usergroup == 0 || $this->usergroup == 3 || $this->usergroup == 4 || $this->usergroup == 5) {
            return false;
        }
    }
    ...
    public function getFriendsList($fetchMode = "")
    {
        ...
        return explode(",", (string) $this->friends);
    }
    ...
    public function sendPasswordEmail($newPass)
    {
        ...
        mail((string) $this->email, "{$mysidia->settings->sitename} - Your password has been changed", $message, $headers);
    }
