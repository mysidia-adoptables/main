...
class UserProfileViewModel extends ViewModel{
    ...
    public function getBio(){
        return stripslashes($this->model->getBio());
    }
    ...
    protected function displayContactinfo(UserContact $contact){
	    ...
	    $contactInfo->add(new Comment($contact->getWebsite() ? $contact->getWebsite() : "No Website Information Given"));
	    $contactInfo->add(new Image("templates/icons/facebook.gif", "facebook"));
	    $contactInfo->add(new Comment($contact->getFacebook() ? $contact->getFacebook() : "No Facebook Information Given"));
	    $contactInfo->add(new Image("templates/icons/twitter.gif", "twitter"));
	    $contactInfo->add(new Comment($contact->getTwitter() ? $contact->getTwitter() : "No Twitter Information Given"));
	    $contactInfo->add(new Image("templates/icons/aim.gif", "aim"));
	    $contactInfo->add(new Comment($contact->getAIM() ? $contact->getAIM() : "No AIM Information Given"));
	    $contactInfo->add(new Image("templates/icons/msn.gif", "msn"));
	    $contactInfo->add(new Comment($contact->getMSN() ? $contact->getMSN() : "No MSN Information Given"));
	    $contactInfo->add(new Image("templates/icons/yahoo.gif", "yahoo"));
	    $contactInfo->add(new Comment($contact->getYahoo() ? $contact->getYahoo() : "No YIM Information Given"));
	    $contactInfo->add(new Image("templates/icons/skype.gif", "skype"));
	    $contactInfo->add(new Comment($contact->getSkype() ? $contact->getSkype() : "No Skype Information Given"));
