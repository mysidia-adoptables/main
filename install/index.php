...
if ($step == 3) {
        ...
        <tr>
            <td height='600px' valign='top' bgcolor='#FFFFFF'>
                ...
                <form name='form1' method='post' action='configwrite.php'>
                    ...
                    <p class='style4'>
                        You must enter your domain name in the form of <strong>yoursite.com</strong> ONLY! &nbsp;DO NOT
                        include the http:// or www. portions of the domain.</p>
                    <p class='style4'>
                        Script Path:
                        <input name='scriptpath' type='text' id='scriptpath' value='<?php echo $scriptPath; ?>'>
                    </p>
                    <p class='style4'>
                        Your script path tells Mysidia Adoptables where it is installed on the server relative to your
                        domain. If you have uploaded this script to the <strong>ROOT</strong> of your domain name then
                        leave the Script Path box blank. If you installed this script in a subfolder, such as <strong>adoptables</strong>,
                        then put the folder name with a slash before it, such as <strong>/adoptables</strong> in the
                        Script Path box.
                    </p>
                    <p class='style4'>
                    ...
                    <p class='style4'>
                        The table prefix determines how the tables in your database are named. In most cases, the
                        adopts_ prefix will do, however if you are running multiple copies of Mysidia Adoptables on the
                        same database, change the table prefix.
                    </p>
                    <p class='style4'>
    ...
    <table border='0' cellpadding='0' cellspacing='0'>
        ...
        <tr>
            <td height='600px' valign='top' bgcolor='#FFFFFF'>
                <p align='left'><br><span class='style2'>This installer will help you install the Mysidia Adoptables Script on your server. Before you can install Mysidia Adoptables, however, you must agree to the Mysidia Adoptables License Agreement as it is outlined below:</span>
                </p>
                <p align='left' class='style3'><u>Mysidia Adoptables License Agreement: </u></p>
                <p align='left' class='style4'>Mysidia Adoptables is licensed under a Free for Non-Commercial Use
                    license, terms of this license are interpreted as the following: </p>
                <p align='left' class='style4'>---Commercial use of the product on your server is OK, while the script
                    may not be redistributed in whole or as part of another script. </p>
                <p align='left' class='style4'>---You must post credit to Mysidia Adoptables
                    (http://www.mysidiaadoptables.com) and keep it visible on all pages unless you have created a
                    credits page. </p>
                <p align='left' class='style4'>---You can create modifications of this script (or hire freelancers to
                    create modifications of this script) at any time. </p>
                <p align='left' class='style4'>For permissions beyond the scope of this license please Contact (Hall of
                    Famer) at halloffamer@mysidiaadoptables.com.</p>
                <p align='right' class='style2'><a href='index.php?step=2'><img src='../templates/icons/yes.gif'
                                                                                border=0> I Agree - Continue
                        Installation</a></p>
            </td>
        </tr>
    </table>
